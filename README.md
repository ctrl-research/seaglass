...
| `F` | Port-forward the selected pod to a local port; picks or prompts for the remote port. The palette's `port-forwards` panel lists active tunnels and cancels them with `ctrl+d` |
